                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href="/Dashboard/CRUD/AdminPelabuhanData/Pelabuhan/Create/{{$id1}}"><i
        ...
        <section class="content">
            <div class="card shadow mb-4">
                <div class="card shadow">
                    <form method="POST" enctype="multipart/form-data" action="{{route('padmin-addpelabuhan')}}">
                        @csrf
                        <input type="hidden" value="{{$id1}}" name="id_padmin">
