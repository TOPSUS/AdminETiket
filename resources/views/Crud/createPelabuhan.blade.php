        ...
        @csrf
            <div class="row card-header">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="nama_pelabuhan" placeholder="Masukan Nama Pelabuhan" name="nama_pelabuhan">
                </div>
                <div class="col">
            ...
            <div class="row card-header">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="lokasi_pelabuhan" placeholder="Masukan Alamat Pelabuhan" name="lokasi_pelabuhan">
                </div>
                <div class="col">
                    <label for="alamat_kantor" class="font-weight-bold text-dark">Alamat Kantor</label>
                    <input type="text" class="form-control" id="alamat_kantor" placeholder="Masukan Alamat Kantor" name="alamat_kantor">
                </div>
            </div>
