                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('create-reward') }}"><i
                                ...
                                <div class="card bg-light">
                                    ...
                                    <div class="card-footer">
                                        <div class="text-right">
                                            <a href="/Dashboard/CRUD/DeleteRewardSpeedboat/{{$rewardSpeedboat->id}}"
                        ...
                        <form action="{{ route('update-rewardspeedboat') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_speedboat" class="custom-select" required>
                                    <option
                                        value="{{$oldRewardSpeedboat->id_speedboat}}">{{$oldRewardSpeedboat->kapal->nama_kapal}}</option>
                                    @foreach($kapal as $sp)
