                                ...
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-center">
                                                <img src="{{asset('/storage/image_users/'.$sadmin->foto)}}" alt=""
                                    ...
                                    <div class="card-footer">
                                        <div class="text-right">
                                            <a href="/Dashboard/CRUD/DeleteUser/{{$sadmin->id}}"
                                               class="btn btn-sm bg-danger">
                                                <i class="fas fa-trash-alt"></i>
                                            </a>
                                            <a data-toggle="modal" data-target="#update{{$sadmin->id}}" href="#"
...
<!-- Modal Update -->
    @foreach($dataSAdmin as $oldSAdmin)
        <div class="modal fade" id="update{{$oldSAdmin->id}}" tabindex="-1" role="dialog"
                        ...
                        <form action="{{ route('update-user') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="Masukan E-mail"
                                       name="email" value="{{$oldSAdmin->email}}" require>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nohp" placeholder="Masukan No Telp"
                                       name="nohp" value="{{$oldSAdmin->nohp}}" require>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="alamat" placeholder="Masukan Alamat"
                                       name="alamat" value="{{$oldSAdmin->alamat}}" require>
                            </div>
                            <div class="form-group">
