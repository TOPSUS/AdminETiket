        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('update-jadwal')}}" enctype="multipart/form-data" method="POST">
                        @csrf
...
/*    function changing(id){
        id_asal = $('#id_asal_pelabuhan_'+id).val();
        $.ajax({
            url: '/kapal/list/' + id_asal,
            method: "GET",
            success: function (data) {
                $('#id_kapal_'+id).empty();
                $('#id_kapal_'+id).append('<option value="">-- Pilih Kapal --</option>');
                jQuery.each(data, function (index, values) {
                    kapal_select = '<option value=' + values.id + '>' + values.nama_kapal + '</option>';
                    $('#id_kapal_'+id).append(kapal_select);
                });
            },
            error: function () {
                $('#id_kapal_'+id).empty();
