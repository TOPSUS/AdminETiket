                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{route('pelabuhan-add')}}">
                        ...
                        <div class="row card-header">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('nama_pelabuhan') is-invalid @enderror"
                                       id="nama_pelabuhan"
                            ...
                            <div class="col">
                                ...
                                <input type="date" step="1"
                                       class="form-control @error('lama_beroperasi') is-invalid @enderror"
                                       id="lama_beroperasi"
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <div class="custom-file">
                                        <input type="file" class="form-group @error('file') is-invalid @enderror"
                                               name="file">
                                        @error('file')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="row card-header">
                            <div class="col">
                                <label for="lokasi_pelabuhan" class="font-weight-bold text-dark">Alamat
                                    Pelabuhan</label>
                                <input type="text" class="form-control @error('lokasi_pelabuhan') is-invalid @enderror"
                                       id="lokasi_pelabuhan"
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('alamat_kantor') is-invalid @enderror"
                                       id="alamat_kantor"
