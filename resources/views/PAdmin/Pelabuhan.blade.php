                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href="/AdminPelabuhan/Pelabuhan/CreatePelabuhan"><i
                                ...
                                <div class="col-9 col-sm-9">
                                    ...
                                    <div class="">
                                        <div class="text-right">
                                            <a href="/AdminPelabuhan/Pelabuhan/DeletePelabuhan/{{$pelabuhan->id}}"
                                            ...
                                            <a href="/AdminPelabuhan/Pelabuhan/Kapal/{{$pelabuhan->id}}" class="btn btn-sm btn-success">
...
@foreach($dataPelabuhan as $oldPelabuhan)
        <div class="modal fade" id="update{{$oldPelabuhan->id}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('pelabuhan-update') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_pelabuhan"
                                       ...
                                       value="{{$oldPelabuhan->nama_pelabuhan}}" require>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" step="1" class="form-control" id="lama_beroperasi"
                                       placeholder="Masukan Asal Speedboat" name="lama_beroperasi"
                                       value="@if($oldPelabuhan->lama_beroperasi!=null){{date('Y-m-d', strtotime($oldPelabuhan->lama_beroperasi))}}@endif" require>
                            </div>
                            <div class="form-group">
                                <label for="lokasi_pelabuhan" class="font-weight-bold text-dark">Alamat
                                    Pelabuhan</label>
                                <input type="text" class="form-control" id="lokasi_pelabuhan"
                                       placeholder="Masukan Alamat Pelabuhan" name="lokasi_pelabuhan"
                                       value="{{$oldPelabuhan->lokasi_pelabuhan}}" require>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="alamat_kantor"
                                       ...
                                       value="{{$oldPelabuhan->alamat_kantor}}" require>
                            </div>
                            <div class="form-group">
                                <label for="foto">Foto Pelabuhan</label>
                            ...
                            <div class="form-group">
                                ...
                                <br>@if($oldPelabuhan->status == "Beroperasi")
                                    <input type="radio" name="status" value="Beroperasi" checked> Beroperasi &nbsp &nbsp
                                    <input type="radio" name="status" value="Tidak Beroperasi"> Tidak Beroperasi &nbsp
                                    &nbsp
                                @else
                                    <input type="radio" name="status" value="Beroperasi"> Beroperasi &nbsp &nbsp
                                    <input type="radio" name="status" value="Tidak Beroperasi" checked> Tidak Beroperasi
                                    &nbsp &nbsp
                                @endif
                            </div>
                            ...
                            @if($oldPelabuhan->tipe_pelabuhan == "feri")
                                ...
                                <input type="radio" name="tipe_pelabuhan" value="speedboat & feri"> Speedboat dan Ferry
                                &nbsp &nbsp
                            @elseif($oldPelabuhan->tipe_pelabuhan == "speedboat")
                                <input type="radio" name="tipe_pelabuhan" value="feri"> Ferry &nbsp &nbsp
                                <input type="radio" name="tipe_pelabuhan" value="speedboat" checked> Speedboat &nbsp
                                &nbsp
                                <input type="radio" name="tipe_pelabuhan" value="speedboat & feri"> Speedboat dan Ferry
                                &nbsp &nbsp
                            @else
                                <input type="radio" name="tipe_pelabuhan" value="feri"> Ferry &nbsp &nbsp
                                <input type="radio" name="tipe_pelabuhan" value="speedboat"> Speedboat &nbsp &nbsp
                                <input type="radio" name="tipe_pelabuhan" value="speedboat & feri" checked> Speedboat
                                dan Ferry &nbsp &nbsp
                        @endif
                    </div>
