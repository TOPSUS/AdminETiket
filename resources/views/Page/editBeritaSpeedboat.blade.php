        ...
        <section class="content">
            ...
            <div class="card shadow mb-4">
                <div class="card shadow">
                    <form method="POST" enctype="multipart/form-data" action="{{route('update-beritaSpeedboat')}}">
                        @csrf
                        ...
                        <div class="form-group card-header">
                            <a href="/Dashboard/BeritaPelabuhan">
                                <button type="button" class="btn btn-secondary">Batal</button>
                            </a>
                            <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i> Apply
                            </button>
                        </div>
                    </form>
                </div>
