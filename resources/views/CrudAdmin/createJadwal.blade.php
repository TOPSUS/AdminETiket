                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{route('addJadwal')}}">
                        ...
                        <div class="form-group card-header">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_asal_pelabuhan" id="id_asal_pelabuhan" class="custom-select @error('id_asal_pelabuhan') is-invalid @enderror" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_tujuan_pelabuhan" id="id_tujuan_pelabuhan" class="custom-select @error('id_tujuan_pelabuhan') is-invalid @enderror"
                                        required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" step="1" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" name="tanggal">
                                @error('tanggal')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" step="1" class="form-control @error('estimasi_waktu') is-invalid @enderror" id="estimasi_waktu"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" step="1" class="form-control @error('harga') is-invalid @enderror" id="harga" placeholder="Masukan Harga"
                                       name="harga">
                                @error('harga')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
