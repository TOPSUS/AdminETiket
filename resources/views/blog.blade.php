...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{asset('clean-assets/favicon.ico')}}assets/favicon.ico" />
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('{{'/storage/kapal_image/'.$blog->foto}}')">
