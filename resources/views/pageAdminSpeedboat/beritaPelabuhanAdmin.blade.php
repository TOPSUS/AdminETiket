        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li><a href="{{ route('createBeritaPelabuhan') }}" class= "btn btn-success text-white"><i class="fas fa-plus"></i> Tambah Berita</a></li>
                  ...
                  <div class="tab-pane" id="speedboat">
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        <span class="username"><a href="#">{{$beritaPelabuhan->relasiUser->nama}}</a>
                      ...
                      <!-- /.row -->
                      <!-- Modal Delete -->
                      <div class="modal fade" id="delete{{$beritaPelabuhan->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <form action="/Berita/{{$beritaPelabuhan->id}}/delete" method="POST">
