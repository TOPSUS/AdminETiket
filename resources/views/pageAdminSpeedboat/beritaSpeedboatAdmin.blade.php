...
<head>
    ...
    <title>Dashboard | Berita Kapal</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li><a href="{{ route('createBeritaSpeedboat') }}" class="btn btn-success text-white"><i
                                    ...
                                    <div class="post">
                                        <div class="user-block">
                                            ...
                                            <span class="username"><a
                                                    href="#">{{$beritaSpeedboat->relasiUser->nama}}</a></span>
                                            <a data-toggle="modal" href="#"
                                               data-target="#delete{{$beritaSpeedboat->id}}"
                                               class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                            <a href="BeritaSpeedboat/{{$beritaSpeedboat->id}}/edit"
                                               class="float-right btn-tool"><i class="fas fa-pen"></i></a>
                                            <span
                                                class="description">{{date('d F Y', strtotime($beritaSpeedboat->created_at)) }}</span>
                                        </div>
                                        <h3 style="text-align:center;"><strong>{{$beritaSpeedboat->judul}}</strong></h3>
                                        <br>
                                        {!! $beritaSpeedboat->berita !!}
                                        <div class="modal fade" id="delete{{$beritaSpeedboat->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/Beritas/{{$beritaSpeedboat->id}}/delete"
                                                          method="POST">
