                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('createRewardSpeedboat') }}"><i
                            ...
                            <div class="col-xl-3 col-sm-3 col-md-3 d-flex">
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-7">
                                                <i class="fas fa-lg fa-donate"></i><b>POIN
                                                    : {{$rewardSpeedboat->minimal_point}}</b>
                                                <ul class="ml-4 mb-0 fa-ul text-muted">
                                                    <br>
                                                    <li class="medium"><span class="fa-li"><i
                                                                class="fas fa-lg fa-gift"></i></span>
                                                        Reward: {{$rewardSpeedboat->reward}}</li>
                                                    <br>
                                                    <li class="medium"><span class="fa-li"><i
                                                                class="fas fa-lg fa-stopwatch"></i></span> Masa Berlaku :
                                                        <br>{{$rewardSpeedboat->berlaku}}</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <div class="text-right">
                                            <a href="/RewardSpeedboat/DeleteRewardSpeedboat/{{$rewardSpeedboat->id}}"
                                               class="btn btn-sm bg-danger">
                                                <i class="fas fa-trash-alt"></i>
                                            </a>
                                            <a data-toggle="modal" data-target="#update{{$rewardSpeedboat->id}}"
...
<!-- Modal Update -->
    @foreach($dataRewardSpeedboat as $oldRewardSpeedboat)
        <div class="modal fade" id="update{{$oldRewardSpeedboat->id}}" tabindex="-1" role="dialog"
                        ...
                        <form action="{{ route('updateRewardSpeedboat') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_kapal" class="custom-select" required>
                                    <option
                                        value="{{$oldRewardSpeedboat->kapal->id}}">{{$oldRewardSpeedboat->kapal->nama_kapal}}</option>
                                    @foreach($kapal as $kp)
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="reward" placeholder="Masukan Nama Reward"
                                       name="reward" value="{{$oldRewardSpeedboat->reward}}" require>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" step="1" class="form-control" id="berlaku"
                                       ...
                                       value="{{date(('Y-m-d'), strtotime($oldRewardSpeedboat->berlaku))}}" require>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="minimal_point" placeholder="Masukan Point"
                                       name="minimal_point" min="0" value="{{$oldRewardSpeedboat->minimal_point}}"
                                       require>
                            </div>
                            <div class="form-group">
